...
public class UserServiceimpl implements UserService {
	...
	//find by id , if not present then throw custom exception
		return repo.findById(id).orElse(() -> new UserNotFoundException("User not found in table"));
	}
	...
	public void deleteUserById(int id) {
		...
		repo.findById(id).orElseGet(() -> new UserNotFoundException("User not found in table"));
		repo.deleteById(id);
